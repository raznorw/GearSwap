...
function init_gear_sets()
	...
	sets.midcast.Cure = {
		...
		sub="Curatio Grip",
		ammo="Hydrocera",      -- "Esper Stone +1",
		head="Gende. Caubeen +1",
		neck="Incanter's Torque",
		ear1="Regal Earring",
		ear2="Glorious Earring",
		body="Vanya Robe",     -- "Ebers Bliaut +1",
		hands="Vanya Cuffs",   -- "Theophany Mitts +3",
	...
	sets.midcast.LightWeatherCuraga = set_combine(sets.midcast.Curaga, {
	    main="Chatoyant Staff",
		-- sub="Curatio Grip",ammo="Esper Stone +1",
		-- head="Gende. Caubeen +1",neck="Incanter's Torque",ear1="Nourish. Earring +1",ear2="Glorious Earring",
		-- body="Kaykaus Bliaut",hands="Theophany Mitts +3",ring1="Janniston Ring",ring2="Lebeche Ring",
		-- back="Twilight Cape",waist="Hachirin-no-Obi",legs="Ebers Pant. +1",feet="Kaykaus Boots"
    })
	...
	sets.midcast.BarElement = {main="Beneficus",sub="Ammurapi Shield",ammo="Hasty Pinion +1",
		...
		body="Ebers Bliaut +1",hands="Ebers Mitts +1",ring1="Stikini Ring",ring2="Stikini Ring",
	...
	sets.midcast['Enfeebling Magic'] = {main="Oranyan",sub="Enki Strap",ammo="Pemphredo Tathlum",
		head="Befouled Crown",neck="Erra Pendant",ear1="Regal Earring",ear2="Digni. Earring",
		body="Theophany Bliaut +2",hands="Regal Cuffs",ring1="Kishar Ring",ring2="Stikini Ring",
	...
	sets.midcast['Enfeebling Magic'].Resistant = {main="Oranyan",sub="Enki Strap",ammo="Pemphredo Tathlum",
		head="Befouled Crown",neck="Erra Pendant",ear1="Regal Earring",ear2="Digni. Earring",
		body="Theophany Bliaut +2",hands="Theophany Mitts +3",ring1="Stikini Ring",ring2="Stikini Ring",
    ...
    sets.defense.MEVA = {ammo="staunch tathlum +1",
		...
		waist="Luminary Sash",
		legs="Sifahir Slacks", -- "Telchine Braconi",
		feet="Inyan. Crackows +1"
		}
