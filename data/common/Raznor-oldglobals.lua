...
function define_global_sets()
    ...
    -- -- Merlinic
	gear.Merl_FC_hands = { name="Merlinic Dastanas", augments={'Mag. Acc.+14 "Mag.Atk.Bns."+14','"Fast Cast"+3','CHR+3',}}
    ...
    gear.BLU_MAB_Cape = { name="Rosmerta's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','"Mag.Atk.Bns."+10','Phys. dmg. taken-10%',}}
    gear.BLU_TP_Cape = { name="Rosmerta's Cape", augments={'DEX+20','Accuracy+20 Attack+20','DEX+5','"Store TP"+10','Phys. dmg. taken-10%',}}
    ...
    gear.COR_WS2_Cape = {name="Camulus's Mantle", augments={'STR+20','Accuracy+20 Attack+20','Weapon skill damage +10%','Phys. dmg. taken-10%',}} --*
