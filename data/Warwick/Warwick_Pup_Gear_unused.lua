...
function user_setup()
	...
	defaultManeuvers = {
		...
		HybridRanged = {
			...
			{Name='Fire Maneuver',	  Amount=1},
			-- {Name='Water Maneuver',	  Amount=1}, -- for skillups
			-- {Name='Dark Maneuver',	  Amount=2}, -- for skillups
			{Name='Light Maneuver',	  Amount=1},
			{Name='Thunder Maneuver', Amount=0},
		},
		Tank = {
		...
		Heal = {
			{Name='Light Maneuver',	  Amount=1}, -- 2
			{Name='Dark Maneuver',	  Amount=1},
			{Name='Water Maneuver',	  Amount=1},
			{Name='Earth Maneuver',	  Amount=0},
		},
		Nuke = {
			...
			{Name='Dark Maneuver',	  Amount=1},
			{Name='Water Maneuver',	  Amount=1},
			{Name='Light Maneuver',	  Amount=1}, -- 0
			{Name='Earth Maneuver',	  Amount=0},
		},
	}
...
function init_gear_sets()
	...
	sets.midcast.Pet.PetWSGear = {
	  ...
	  ring1="Varar Ring",
	  ring2="Varar Ring",       -- TODO: +1
	  -- back=-- TODO: "Dispersal Mantle",
	  waist="Incarnation Sash",
	  legs="Karagoz Pantaloni",  -- TODO: +1
	  feet="Punchinellos" -- TODO: Naga Kyahan - Zi'tah
  }
	...
	-- TODO: whole set(s)
    sets.engaged = {
        head="Tali'ah Turban +1", -- TODO: +2
		neck="Subtlety Spec.",  -- TODO: "Shulmanu Collar",
        ...
        back="Visucius's Mantle",
		waist="Moonbow Belt",
		legs="Herculean Trousers", -- TODO: "Ryuo Hakama",
		feet="Tali'ah Crackows +1" -- TODO: gear.herculean_ta_feet
	}
    sets.engaged.Acc = {
    ...
    sets.engaged.Pet = {
		...
		neck="Shulmanu Collar",ear1="Cessance Earring",ear2="Telos Earring",
        body="Sayadio's Kaftan",hands="Ryuo Tekko",ring1="Niqmaddu Ring",ring2="Epona's Ring",
        back="Visucius's Mantle",
		waist="Moonbow Belt", -- "Klouskap Sash",
		legs="Ryuo Hakama",feet=gear.herculean_ta_feet}
