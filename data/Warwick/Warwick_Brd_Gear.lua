-- TODO: Add an MEVA Defense mode if one doesn't exist
function user_setup()
...
function init_gear_sets()
	...
	sets.precast.FC.BardSong = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",range="Blurred Harp",ammo=empty,
	...
	sets.midcast.SongDebuff = {
	  main="Kali",
	  -- sub="Ammurapi Shield",
	  range="Eminent Flute", -- "Marsyas",	 
      head="Inyanga Tiara +1", -- "Aya. Zucchetto +2",
	  neck="Moonbow Whistle",
	  ear1="Gwati Earring",
	  ear2="Digni. Earring",
	  body="Fili Hongreline +1",
	...
	sets.midcast.SongRecast = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",range="Blurred Harp",ammo=empty,
		head="Nahtirah Hat",neck="Voltsurge Torque",ear1="Enchntr. Earring +1",ear2="Loquacious Earring",
