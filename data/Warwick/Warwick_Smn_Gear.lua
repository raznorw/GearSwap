...
function user_setup()
	...
	gear.magic_jse_back = "Campestres's Cape" -- {name="Campestres's Cape",augments={'Pet: M.Acc.+20 Pet: M.Dmg.+20','Eva.+20 /Mag. Eva.+20','Pet: "Regen"+10',}}
	gear.phys_jse_back = "Campestres's Cape" -- {name="Campestres's Cape",augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Eva.+20 /Mag. Eva.+20','Pet: Haste+10',}}
...
function init_gear_sets()
	...
	-- {
	  ...
	  -- sub="Elan Strap",
	  -- ammo="Sancus Sachet +1",
      -- head="Apogee crown +1", -- "Helios Band",
	  -- neck="Smn. Collar +1", -- "Shulmanu Collar",
	  -- -- ear1="Gelos Earring",
	  -- -- ear2="Lugalbanda Earring",
      -- 
	  -- hands="Merlinic Dastanas", -- gear.merlinic_physpact_hands,
	  -- ring1="Varar Ring",
	  -- -- ring2="Varar Ring +1",
      -- -- back=gear.phys_jse_back,
	  -- waist="Incarnation Sash",
	  -- legs="Merlinic Shalwat", -- "Apogee Slacks +1",
	  -- feet="Apogee Pumps +1"
	-- }
    ...
    sets.idle = {
	  ...
	  sub="Genmei Shield",ammo="Staunch Tathlum",
		...
		feet="Apogee Pumps +1" --  "Baayami Sabots"
		}

    sets.idle.PDT = {main="Terra's Staff",sub="Oneiros Grip",ammo="Staunch Tathlum",
        head="Hagondes Hat +1",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Ethereal Earring",
    ...
    sets.defense.PDT = {main="Terra's Staff",sub="Umbra Strap",ammo="Sancus Sachet +1",
        head="Hagondes Hat +1",neck="Loricate Torque",ear1="Handler's Earring +1",ear2="Enmerkar Earring",
        body="Vrikodara Jupon",hands="Hagondes Cuffs +1",ring1="Defending Ring",ring2="Dark Ring",
        back="Umbra Cape",waist="Regal Belt",legs="Hagondes Pants +1",feet="Battlecast Gaiters"}

    sets.defense.MDT = {main="Terra's Staff",sub="Umbra Strap",ammo="Sancus Sachet +1",
        head="Hagondes Hat +1",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Lugalbanda Earring",
        body="Vrikodara Jupon",hands="Hagondes Cuffs +1",ring1="Defending Ring",ring2="Dark Ring",
        back="Umbra Cape",waist="Regal Belt",legs="Hagondes Pants +1",feet="Battlecast Gaiters"}
    ...
    sets.engaged = {
	  ...
	  -- ring2="Ramuh Ring +1",
      back=gear.phys_jse_back,
	  waist="Klouskap Sash", -- "Olseni Belt",
	  -- legs="Assid. Pants +1",
	  feet="Apogee Pumps +1", -- need -perpetutation "Tali'ah Crackows +1" -- "Convo. Pigaches +3"
	}
end
