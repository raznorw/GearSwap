function user_setup()
	...
	state.Weapons:options('Godhands','Karambit', 'ProcStaff','ProcClub','Barehanded','ProcSword','ProcGreatSword','ProcScythe','ProcPolearm','ProcGreatKatana')
...
function init_gear_sets()
	...
	sets.precast.WSFullAcc = set_combine(sets.precast.WSAcc, {	
	  head="Mummu Bonnet +2",
	  neck="Moonbeam Nodowa",
	  ear1="Zennaroi Earring",
	  ear2="Telos Earring",
	...
	sets.engaged.FullAcc = set_combine(sets.engaged.Acc, {
	  head="Mummu Bonnet",   -- +2
	  neck="Subtlety spec.", -- "Moonbeam Nodowa",
	  ear1="Zennaroi Earring",
	  ear2="Telos Earring",
	  body="Mummu Jacket +1", -- +2
	  hands="Mummu Wrists +1",  -- "Ryuo Tekko",
	  ring1="Ramuh Ring +1",
	  ring2="Ramuh Ring +1",
	  waist="Olseni Belt",
	  legs="Mummu Kecks +1"  -- "Hiza. Hizayoroi +2"	  
	})
