...
function get_sets()
    ...
    }) -- Master DT: 10 (ring), 2 (ammo), 5 (neck)   PDT: 1(hands) -- currently 18/17, very low
    ...
    sets.midcast.casting = {
		...
		left_ring={ name="Diamond Ring", augments={'INT+1','Ice resistance+1',}},
