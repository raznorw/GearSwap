...
function user_setup()
    ...
    state.JugMode = M{['description']='Jug Mode', 
		...
		'RedolentCandi'         -- Electrified Broth NQ
		}
		-- Sugary Broth   -- Colibri
		-- Lyrical Broth  -- Rhyming Shizuna
		
		-- Rapid Broth    -- Fleet Reinhard
		-- Crackling Broth -- Ankelbiter Jedd
	...
	send_command('bind !z gs c ready one')
	send_command('bind !x gs c ready two')
	send_command('bind !c gs c ready three')
	send_command('bind !v gs c ready four')
	
	send_command('bind ![ input /ja "Call Beast" <me>')
...
function init_gear_sets()
    ...
    Ready_Atk_Axe = { name="Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+13','Pet: Phys. dmg. taken -2%','Pet: TP Bonus+140',}} -- "Aymur"
    Ready_Atk_Axe2 = "Arktoi"
    Ready_Atk_TPBonus_Axe = { name="Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+13','Pet: Phys. dmg. taken -2%','Pet: TP Bonus+140',}} -- "Aymur"
    ...
    Pet_TP_AxeMain = Ready_Atk_Axe -- "Skullrender"
    Pet_TP_AxeSub = "Deacon Tabar" -- "Skullrender"
	
    Ready_Acc_Axe = { name="Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+13','Pet: Phys. dmg. taken -2%','Pet: TP Bonus+140',}} -- "Arktoi"
	...
	Ready_MAB_Axe = { name="Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+13','Pet: Phys. dmg. taken -2%','Pet: TP Bonus+140',}}
	Ready_MAB_Axe2 = { name="Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+10','Pet: Phys. dmg. taken -1%','STR+10 CHR+10',}}
	Ready_MAB_TPBonus_Axe ={ name="Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+13','Pet: Phys. dmg. taken -2%','Pet: STR+3 Pet: DEX+3 Pet: VIT+3',}}
	Ready_MAB_TPBonus_Axe2 = { name="Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+10','Pet: Phys. dmg. taken -1%','STR+10 CHR+10',}}
    ...
    Ready_Atk_head = "Despair Helm" -- "Emicho Coronet +1"
    Ready_Atk_body = "Tali'ah Manteel +1" -- {name="Valorous Mail", augments={'Pet: Attack+27 Pet: Rng.Atk.+27','Pet: STR+14','Pet: Accuracy+14 Pet: Rng. Acc.+14',}}
    Ready_Atk_hands = "Nakumi Manoplas" -- "Emicho Gauntlets +1"
    Ready_Atk_legs = "Despair Cuisses" -- "Totemic Trousers +3"
    Ready_Atk_feet = { name="Acro Leggings", augments={'Pet: Attack+23 Pet: Rng.Atk.+23','Pet: Crit.hit rate +4',}} -- "Totemic Gaiters +3"
    Ready_Atk_back = "Artio's Mantle" -- {name="Artio's Mantle", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Eva.+20 /Mag. Eva.+20','Pet: Attack+10 Pet: Rng.Atk.+10','Pet: Haste+10','System: 1 ID: 1246 Val: 4',}}

    Ready_Acc_head = "Tali'ah Turban +1" -- "Totemic Helm +3"
    Ready_Acc_body = "Tali'ah Manteel +1" -- {name="Valorous Mail", augments={'Pet: Accuracy+27 Pet: Rng. Acc.+27','Pet: "Dbl.Atk."+1 Pet: Crit.hit rate +1','Pet: DEX+10','Pet: Attack+14 Pet: Rng.Atk.+14',}}
    ...
    Ready_Acc_feet = "Tali'ah Crackows +1" -- {name="Valorous Greaves", augments={'Pet: Accuracy+28 Pet: Rng. Acc.+28','Pet: "Dbl.Atk."+1 Pet: Crit.hit rate +1','Pet: DEX+9','Pet: Attack+15 Pet: Rng.Atk.+15',}}
    ...
    Ready_MAB_head = { name="Acro Helm", augments={'Pet: "Mag.Atk.Bns."+23',}}
    -- Ready_MAB_body = "Emicho Haubert +1"
	Ready_MAB_body = "Tali'ah Manteel +1"
    Ready_MAB_hands = "Nakumi Manoplas"
    Ready_MAB_legs = { name="Acro Breeches", augments={'Pet: "Mag.Atk.Bns."+25',}}
    Ready_MAB_feet = { name="Acro Leggings", augments={'Pet: "Mag.Atk.Bns."+16','Pet: "Regen"+1','Pet: Haste+2',}}
    ...
    Pet_Melee_head = "Despair Helm" -- "Emicho Coronet +1"
    ...
    DW_head = "Tali'ah Turban +1" -- {name="Taeon Chapeau", augments={'Accuracy+19 Attack+19','"Dual Wield"+5','STR+3 VIT+3',}}
    DW_body = "Tali'ah Manteel +1" -- {name="Taeon Tabard", augments={'Accuracy+20 Attack+20','"Dual Wield"+5','Crit. hit damage +2%',}}
    DW_hands = "Tali'ah Gages +1" -- {name="Taeon Gloves", augments={'Accuracy+18 Attack+18','"Dual Wield"+5','MND+9',}}
    DW_legs = "Despair Cuisses" -- {name="Taeon Tights", augments={'Accuracy+22','"Dual Wield"+5','Crit. hit damage +2%',}}
    DW_feet = "Tali'ah Crackows +1" -- {name="Taeon Boots", augments={'Accuracy+23','"Dual Wield"+5','Crit. hit damage +2%',}}
    ...
    CB_hands = "Ankusa Gloves" -- "Ankusa Gloves +3"
	...
	sets.precast.JA.Reward = {ammo="Pet Food Theta",
        ear1="Ferine Earring",ear2="Pratik Earring",
        body="Totemic Jackcoat +1",
        back="Artio's mantle",legs="Totemic Trousers +1",feet="Totemic Gaiters +1"}
    --sets.precast.JA.Reward = {ammo="Pet Food Theta",
    ...
    sets.midcast.Pet.WS = {ammo="Demonry Core",
		...
		ear1="Hija Earring",
		ear2="Ferine Earring", -- "Ruby Earring",
        body=Ready_Atk_body,
        hands=Ready_Atk_hands,
        ring1="Thurandaut Ring", -- "Thurandaut Ring +1",
        ring2="Varar Ring", -- "Varar Ring +1",
        back=Ready_Atk_back,
    ...
    sets.midcast.Pet.HighAcc = set_combine(sets.midcast.Pet.MedAcc, {
        ear1="Ferine Earring",
        -- waist="Klouskap Sash +1",
        feet=Ready_Acc_feet})

    sets.midcast.Pet.MaxAcc = set_combine(sets.midcast.Pet.HighAcc, {
        -- head="Totemic Helm +3",
        ear1="Ferine Earring",
    ...
    sets.idle = {ammo="Staunch Tathlum",
		...
		neck="Loricate Torque", -- "Bathy Choker +1",
		-- ear1="Infused Earring",ear2="Dawn Earring",
		ear1="Enmerkar Earring",
		ear2="Handler Earring +1",
        body="Meghanada Cuirie +1",
		hands="Meg. Gloves +1",
		ring1="Moonbeam Ring",
		ring2="Defending Ring", --"Paguroidea Ring",
        back="Moonbeam Cape", -- "Solemnity Cape"
    ...
    sets.idle.Pet.Engaged = {ammo="Demonry Core",
        ...
        neck="Shulmanu Collar",
		ear1="Hija Earring",
		ear2="Enmerkar Earring", -- "Domesticator's Earring",
        body=Pet_Melee_body,
        hands=Pet_Melee_hands,
        ring1="Varar Ring",ring2= "Thurandaut Ring", -- "Varar Ring +1",
        back=Ready_Atk_back,
        waist="Klouskap sash", -- "Incarnation Sash",
        legs=Pet_Melee_legs,
        feet=Pet_Melee_feet}
    ...
    sets.defense.PDT = {ammo="Iron Gobbet",
        head="Meghanada Visor +1",neck="Loricate Torque +1",ear1="Impregnable Earring",ear2="Genmei Earring",
        body="Tartarus Platemail",hands="Meghanada Gloves",ring1="Moonbeam Ring",ring2="Defending Ring", -- "Warden's Ring",
    ...
    -------------------------------------------------------
    sets.IdleAxeShield = {main="Freydis",sub="Adapa Shield"} -- "Beatific Shield +1"
    sets.PDTAxeShield = {main="Freydis",sub="Adapa Shield"}
    sets.MDTAxeShield = {main="Purgation",sub="Adapa Shield"} -- "Beatific Shield +1"
    sets.MEvaAxeShield = {main=MEva_Axe_main,sub="Adapa Shield"} -- "Beatific Shield +1"
    sets.PetPDTAxeShield = {main=Pet_PDT_AxeMain,sub="Adapa Shield"} -- "Beatific Shield +1"
    sets.PetMDTAxeShield = {main=Pet_MDT_AxeMain,sub="Adapa Shield"} -- "Beatific Shield +1"
    sets.PetTPAxeShield = {main=Pet_TP_AxeMain,sub="Adapa Shield"} -- "Beatific Shield +1"
    sets.PetRegenAxeShield = {main=Pet_Regen_AxeMain,sub="Adapa Shield"} -- "Beatific Shield +1"
    ...
    sets.engaged = {ammo="Ginsen",
        ...
        back=STR_DA_back,
		waist="Windbuffet Belt +1",legs="Meghanada Chausses +2",feet="Argosy Sollerets +1"}

    ------------------------------------
    -- DUAL-WIELD MASTER ENGAGED SETS --
    ------------------------------------

    sets.engaged.DW = {ammo="Demonry Core", -- "Paeapua",
        head=DW_head,
    ...
    sets.precast.WS = {ammo="Floestone",
		head="Meghanada Visor +1",neck="Sanctity Necklace",
		ear1="Brutal Earring",ear2="Telos Earring",
        body="Meghanada Cuirie",hands="Meg. Gloves +1",ring1="Moonbeam Ring",ring2="Defending Ring", --"Paguroidea Ring",
        waist="Windbuffet Belt +1",legs="Meghanada Chausses",feet="Meg. Jam. +1"}
    ...
    sets.precast.WS['Rampage'] = set_combine(sets.precast.WS, {
        head="Heyoka Cap",neck="Fotia Gorget",ear1="Sherida Earring",
    ...
    sets.precast.WS['Calamity'] = set_combine(sets.precast.WS, { hands="Meghanada Gloves +2" })
