...
-- https://raw.githubusercontent.com/ArislanShiva/luas/master/Arislan-COR.lua
...
function job_setup()
    -- QuickDraw Selector
    state.Mainqd = M{['description']='Primary Shot', 'Fire Shot', 'Ice Shot', 'Wind Shot', 'Earth Shot', 'Thunder Shot', 'Water Shot', 'Light Shot'}
    state.Altqd = M{['description']='Secondary Shot', 'Fire Shot', 'Ice Shot', 'Wind Shot', 'Earth Shot', 'Thunder Shot', 'Water Shot', 'Light Shot'}
...
function user_setup()
    ...
    gear.RAbullet = "Eminent bullet" -- "Chrono Bullet"
    gear.WSbullet = "Eminent bullet" -- "Chrono Bullet"
    gear.MAbullet = "Bronze Bullet" -- "Living Bullet"
    gear.QDbullet = "Bronze Bullet" -- "Living Bullet"
...
function init_gear_sets()
    ...
    sets.precast.CorsairRoll = {
        ...
        -- ring1="Barataria Ring", -- "Gelatinous Ring +1", --7/(-1)
    ...
    sets.precast.RA = {
        ...
        body="Laksa. Frac +3", -- 0/20 -- "Oshosi Vest +1", --14/0
        -- hands="Carmine Fin. Ga. +1", --8/11
        -- legs=gear.Adhemar_D_legs, --9/10
        feet="Meg. Jam. +1", --8/0, +2 is 10/0
        back="Navarch's mantle", -- 6.5/0 I Think --- gear.COR_SNP_Cape, --10/0
    ...
    sets.precast.WS = {
        ammo=gear.WSbullet,
		head=gear.Adhemar_D_head,  -- "Lanun Tricorne +3",
        body="Laksa. Frac +3",
        hands="Meg. Gloves +2",
        legs="Herculean Trousers", -- gear.Herc_RA_legs, -- currently only have 1 set
        feet="Mummu Gamash. +1", -- "Lanun Bottes +3",
        -- neck="Fotia Gorget",
        -- ear1="Moonshade Earring",
        -- ear2="Ishvara Earring",
        -- ring1="Regal Ring",
        -- ring2="Dingir Ring",
        back=gear.COR_WS2_Cape, -- gear.COR_WS3_Cape,
        -- waist="Fotia Belt",
        }

    sets.precast.WS.Acc = set_combine(sets.precast.WS, {
        -- legs=gear.Adhemar_C_legs,
        feet="Mummu Gamash. +1", -- gear.Herc_RA_feet,
        ear2="Telos Earring",
        -- neck="Iskur Gorget",
        -- ring2="Hajduk Ring +1",
    ...
    sets.precast.WS['Wildfire'] = {
        ...
        -- ring1="Ilabrat Ring",
        -- ring2="Dingir Ring",
        back=gear.COR_WS2_Cape, -- gear.COR_WS1_Cape,
        -- waist="Eschan Stone",
        }
    ...
    sets.precast.WS['Evisceration'] = {
        head=gear.Adhemar_D_head, -- Adhemar_B_head
        -- body="Abnoba Kaftan",
        ...
        -- ring1="Regal Ring",
        -- ring2="Mummu Ring",
        back=gear.COR_WS2_Cape, -- gear.COR_TP_Cape,
        -- waist="Fotia Belt",
        }
    ...
    sets.precast.WS['Swift Blade'] = set_combine(sets.precast.WS, {
        head=gear.Adhemar_D_head,  -- gear.Adhemar_B_head,
        -- body=gear.Adhemar_B_body,
    ...
    sets.midcast.CorsairShot.Resistant = set_combine(sets.midcast.CorsairShot, {
        head="Mummu Bonnet +1",      -- "Laksa. Tricorne +3",
        -- body="Mummu Jacket +2",
        hands="Mummu Wrists +1",     -- "Laksa. Gants +3",
        -- legs="Mummu Kecks +2",
        feet="Mummu Gamash. +1",     -- "Laksa. Boots +3",
        neck="Sanctity Necklace",
        ear1="Gwati Earring",        -- "Hermetic Earring",
        -- ear2="Digni. Earring",
        ring1="Mummu Ring",          -- "Regal Ring",
    ...
    sets.midcast.RA = {
        -- ammo=gear.RAbullet,
        head="Meghanada Visor +1", -- "Lanun Tricorne +3",
		body="Laksa. Frac +3",   -- "Oshosi Vest +1",
        hands="Meg. Gloves +2",    -- gear.Adhemar_C_hands,
        legs="Meg. Chausses",      -- gear.Adhemar_C_legs,
        feet="Meg. Jam. +1",       -- +2 goal
        neck="Sanctity Necklace",  -- "Iskur Gorget",
        ear1="Matanki Earring",    -- "Enervating Earring",
        ear2="Telos Earring",
        ring1="Meghanada Ring",    -- "Ilabrat Ring",
        ring2="Petrov Ring",       -- "Dingir Ring",
        -- back="Navarch's mantle", -- gear.COR_RA_Cape,
        -- waist="Yemaya Belt",
        }
    ...
    sets.idle = {
        -- ammo=gear.MAbullet,
        head=gear.Adhemar_D_head, -- "Volte Cap",
        -- body="Oshosi Vest +1",
        ...
        -- ring1="Chirich Ring +1",
        -- ring2="Chirich Ring +1",
        back="Moonbeam Cape", -- "Moonlight Cape",
        waist="Flume Belt +1",
        }

    sets.idle.DT = set_combine(sets.idle, {
        head="Meghanada Visor +1", --4/0, +2 is 5/0
        -- body="Lanun Frac +3", --6/0
        -- hands=gear.Herc_DT_hands, --7/5
        feet="Ahosi Leggings", --4/0
        neck="Loricate Torque", -- 5/5, +1 is 6/6
        -- ear1="Genmei Earring", --2/0
        -- ear2="Etiolation Earring", --0/3
        ring2="Defending Ring", --10/10
        back="Moonbeam Cape", -- "Moonlight Cape", -- 5/5, 6/6 for HQ
        waist="Flume Belt +1", --4/0
        })
    ...
    sets.engaged = {
        head=gear.Adhemar_D_head,  -- gear.Adhemar_B_head,
        body="Rawhide vest",       -- gear.Adhemar_B_body,
        hands=gear.Adhemar_B_hands,
        legs="Carmine Cuisses +1", -- "Herculean Trousers", -- "Samnuha Tights",
        feet="Herculean Boots",    -- "Mummu Gamash. +1",   -- gear.Herc_TA_feet,
        neck="Sanctity Necklace",  -- "Iskur Gorget",
        ear1="Telos Earring",        -- "Cessance Earring",
        ear2="Brutal Earring",
        ring1="Petrov Ring",       -- "Hetairoi Ring",
        ring2="Rajas ring",        -- "Epona's Ring",
        back=gear.COR_WS2_Cape,    -- gear.COR_TP_Cape,
        waist="Windbuffet Belt +1",
        }
    ...
    sets.engaged.LowAcc = set_combine(sets.engaged, {
		head="Meghanada Visor +1", -- "Lanun Tricorne +3",
		body="Meg. Cuirie +1",   -- "Oshosi Vest +1",
        hands="Meg. Gloves +2",    -- gear.Adhemar_C_hands,
        legs="Carmine Cuisses +1",
        feet="Meg. Jam. +1",       -- +2 goal
        neck="Sanctity Necklace",  -- "Combatant's Torque", "Iskur Gorget",
        ear1="Matanki Earring",    -- "Enervating Earring",
        ear2="Telos Earring",
        ring1="Meghanada Ring",    -- "Ilabrat Ring",
        ring2="Petrov Ring",       -- "Dingir Ring",
    ...
    sets.engaged.DW = set_combine(sets.engaged, {
        ...
        -- legs="Carmine Cuisses +1", --6 (Path D)
    ...
    sets.engaged.Hybrid = {
		...
		waist="Flume Belt +1",      --  4/0  Mike
		feet="Ahosi Leggings",      --  4/0  Mike addition, not here before
		legs="Meg. Chausses +2",    --  6/0
		back=gear.COR_WS2_Cape,     -- 10/0
        } -- 50/15 -- could swap cape to 5 DT and 45/20
    ...
    sets.CP = { 
	  back="Aptitude Mantle" -- "Mecisto. Mantle"
	}
