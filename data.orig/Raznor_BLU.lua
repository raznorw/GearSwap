...
include('Raznor-globals.lua')  -- auto-included if using a mote base
...
function get_sets()
	maps()
     ...
     TaeonHead = {}
     TaeonHead.TP = { name="Taeon Chapeau", augments={'Accuracy+20 Attack+20','"Triple Atk."+2',}}

	TaeonBody = {}
	TaeonBody.FC = { name="Taeon Tabard", augments={} }
		
	TaeonHands = {}
	TaeonHands.TP = { name="Taeon Gloves", augments={'Accuracy+14','"Triple Atk."+2','Weapon skill damage +1%',}}
		
	TaeonBoots = {}
	TaeonBoots.TP = { name="Taeon Boots", augments={'Accuracy+15','Potency of "Cure" effect received+2%',}}

     RawhideVest = {}
     RawhideVest.TP = { name="Rawhide Vest", augments={'HP+50','"Subtle Blow"+7','"Triple Atk."+2',}}
	...
	sets.TP.DualWield = {
		...
		neck = "Sanctity Necklace",  -- or maybe asperity?  att +*, STP 3, DA 2
		ear1 = "Suppanomimi",
		ear2 = "Brutal Earring",
		body = "Ayanmo Corazza +2", -- RawhideVest.TP,
		hands = gear.Adhemar_B_hands,
		ring1 = "Defending Ring", -- "Enlivened Ring",
		ring2 = "Rajas Ring",
	...
	sets.DT.DT = {
		...
		back = "Moonbeam cape",        --  5/5   -- todo: rosemerta's with 10 PDT
	...
	sets.Requiescat.Attack = {
		...
		neck = "Sanctity Necklace", -- "Soil Gorget"
		ear1 = "Suppanomimi",
		ear2 = "Brutal Earring",
		body = "Jhakri Robe +1",
	...
	sets.Expiacion.Attack = set_combine(sets.CDC.Mike, {
	})
	...
	BlackHalo_ind = 1
	sets.BlackHalo.Attack = set_combine(sets.CDC.Mike, {
	})
...
-- 		hands = HerculeanGloves.DT,
	...
	sets.precast.FastCast.Standard = {
		...
		head = "Herculean Helm",   -- 7, no augments
		neck = "Voltsurge Torque", -- 4 -- "Orunmila's Torque",
		ear1 = "Loquac. Earring",  -- 2
		-- ear2 = "Etiolation Earring", -- don't have
		-- body = TaeonBody.FC,
		hands = "Leyline Gloves", -- 6?, can get better aug'd version
		-- ring1 = "Kishar Ring",  -- don't have
