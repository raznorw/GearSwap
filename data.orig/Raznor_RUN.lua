...
function init_gear_sets()
    ...
    sets.Enmity = {
        ...
        neck="Futhark Torque", -- "Moonbeam Necklace", --10
        ear1="Friomisi Earring", -- "Cryptic Earring", --4
        -- ear2="Trux Earring", --5
        ring1="Provocare Ring", -- "Supershear Ring", --5
        ring2="Petrov Ring",    -- "Eihwaz Ring", --5
    ...
    sets.Enmity.HP = set_combine(sets.Enmity, {
        ...
        ring1="Moonbeam Ring", -- "Moonlight Ring",
        })
    ...
    sets.precast.FC = {
        -- ammo="Sapience Orb", --2
        head="Runeist Bandeau",      -- "Rune. Bandeau +3", --14
        body="Taeon Tabard",         -- gear.Taeon_FC_body, --8
        hands="Leyline Gloves", --5 / 8
        legs="Ayanmo Cosciales",     -- 3 "Aya. Cosciales +2", --6
        -- feet="Carmine Greaves +1", --8
        neck="Voltsurge Torque",     -- "Orunmila's Torque", --5
        ear1="Odnowa Earring",
        ear2="Odnowa Earring +1",
        ring1="Moonbeam Ring",       -- "Moonlight Ring",
    ...
    sets.precast.FC.HP = set_combine(sets.precast.FC, {
        ...
        -- head="Rune. Bandeau +3",
        body="Futhark Coat +1", -- "Runeist's Coat +3",
        ear1="Odnowa Earring",
        ear2="Odnowa Earring +1",
        ring1="Moonbeam Ring",
        -- waist="Oneiros Belt",
    ...
    sets.precast.WS = {	
        ammo="Knobkierrie",
        head=gear.Adhemar_D_head,  -- "Lilitu Headpiece",
        body="Meg. Cuirie +1",     -- gear.Herc_WS_body,
        hands="Meg. Gloves +2", 
        legs="Meg. Chausses +1",     -- gear.Herc_WS_legs,
        feet="Meg. Jam. +1",      -- gear.Herc_TA_feet,
        neck="Anu Torque",        -- "Sanctity Necklace", -- "Fotia Gorget",
        ear1="Brutal Earring",    -- "Sherida Earring",
        ear2="Telos Earring", -- "Moonshade Earring",
        ring1="Moonbeam Ring",    -- "Regal Ring",
        ring2="Meghanada Ring",   -- "Niqmaddu Ring",
        -- back="Buquwik Cape",      -- gear.RUN_WS1_Cape,  (loses 250 HP from moonbeam cape)
        waist="Windbuffet Belt +1", -- "Fotia Belt",
        }
    ...
    sets.idle = {
        sub="Balarama Grip",      -- "Mensch Strap +1",
        ammo="Staunch Tathlum",   -- "Homiliary",
        head="Fu. Bandeau +1",
        body="Futhark Coat +1",    -- "Runeist's Coat +3",
        ...
        feet="Turms Leggings",      
        -- neck="Bathy Choker +1",
        ear1="Odnowa Earring",        -- "Infused Earring",
        ear2="Odnowa Earring +1",     -- "Genmei Earring",
        -- ring1="Stikini Ring +1",
        -- ring2="Stikini Ring +1",
    ...
    sets.idle.DT = {
        ...
        ammo="Staunch Tathlum",   --  2/2  (hq is 3/3)
        head="Fu. Bandeau +1",    --  4/0   6/0 for +3
        body="Futhark Coat +1",   --  7/7         -- "Runeist's Coat +3",
        hands="Turms Mittens +1",
        legs="Ayanmo Cosciales",  --  3/3         -- "Carmine Cuisses +1",
        feet="Meg. Jam. +1",      --  3/0 "Ahosi Leggings", --4/0
        neck="Oneiros Torque",    --  2/0          -- "Loricate Torque +1", --6/6
        ear1="Odnowa Earring",    --  0/1         -- "Eabani Earring",
        ear2="Odnowa Earring +1", --  0/2
        ring1="Moonbeam Ring",    --  4/4           -- "Gelatinous Ring +1", --7/(-1)
        ring2="Defending Ring",   -- 10/10
        back="Moonbeam cape",     --  5/5             -- "Evasionist's Cape", --7/4
    ...
    sets.defense.PDT = {
        sub="Refined Grip +1",       --  3/3
        ammo="Staunch Tathlum",      --  2/2 -- need +1 for 3/3
        head="Meghanada Visor +1",   --  4/0 "Fu. Bandeau +1",       --  4/0    "Fu. Bandeau +3", --6/0
        body="Futhark Coat +1",      --  7/7 -- "Futhark Coat +3" 9/9
        hands="Turms Mittens +1",
        legs="Meg. Chausses +2",     --  6/0 -- "Eri. Leg Guards +1", --7/0
        feet="Turms Leggings",
        neck="Loricate Torque",      --  5/5, +1 is 6/6
		                             --       Wiglen Gorget 6/-6 -- do I have enough MDT to use?
        ear1="Odnowa Earring",       --  0/1 -- "Eabani Earring",
        ear2="Odnowa Earring +1",    --  0/2
        ring1="Moonbeam Ring",       --  4/4 -- "Gelatinous Ring +1", --7/(-1)
        ring2="Defending Ring",      -- 10/10
        back="Moonbeam Cape",        --  5/5   -- gear.RUN_HPP_Cape,
        waist="Flume Belt +1",       --  4/0
        } -- currently 50/39
    ...
    sets.defense.MDT = set_combine(sets.defense.PDT, {
        ...
        -- feet="Turms Leggings +1",
        neck="Futhark Torque",         -- "Warder's Charm +1",
        ...
        -- waist="Engraved Belt",
        }) -- 50/27 - ton of extra elemental/evasion

    sets.defense.Status = set_combine(sets.defense.PDT, {
        -- sub="Irenic Strap +1", --0/5
        -- ammo="Staunch Tathlum +1", --3/3
        -- head="Rune. Bandeau +3",
    ...
    sets.engaged = {
	    -- sub="Balarama Grip",            -- "Utu Grip",
        ammo="Staunch Tathlum", -- 2/2  (hq is 3/3)
        head=gear.Adhemar_D_head,
        body="Ayanmo Corazza +2", -- "Rawhide Vest", 
        hands=gear.Adhemar_B_hands,
        legs="Meg. Chausses +1",   -- "Ayanmo Cosciales",  -- 3/3         -- "Carmine Cuisses +1",
        feet="Meg. Jam. +1", 
        neck="Anu Torque",
        ear1="Brutal Earring",
        ear2="Telos Earring", --0/2
        ring1="Moonbeam Ring",  -- 4/4           -- "Gelatinous Ring +1", --7/(-1)
        ring2="Petrov Ring",
        back="Moonbeam cape",   --5/5             -- "Evasionist's Cape", --7/4
    ...
    sets.buff.Doom = {
        neck="Malison Medallion", -- "Nicander's Necklace", --20
